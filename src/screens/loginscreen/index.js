...
const Login = () => {
    ...
    return(
        <>
        <div className="ui raised segment align-center" style={{height:'auto',margin:'8vh',background:'lightgray'}}>
                    ...
                    <div className="seven wide column ">
                        ...
                        <div className="ui equal width grid margin-no">
                            ...
                            <div className="row padding-no" >
                                <div className="five wide column"  style={{paddingRight:'0%',width:'fit-content'}}>
                            ...
                            <div className="row " style={{paddingBottom:0}}>
                                <div className="twelve wide column " >
                                <button className="ui button"  style={{width:'100%'}}>LOGIN</button>
                                </div>
                            </div>
